...
# -------------------------------------------------------------------------
# Helper: check if a path exists in DBFS/Volumes
# -------------------------------------------------------------------------
...
# -------------------------------------------------------------------------
# Helper: copy dataset files if not already present
# -------------------------------------------------------------------------
...
# Free/Community Edition does NOT have hive_metastore, so we always use workspace
...
# Prepare catalog + schema + volumes
...
print(f"Dataset path: {dataset_bookstore}")
print(f"Checkpoints path: {checkpoints_bookstore}")

# -------------------------------------------------------------------------
# Helper: get next file index in a directory
# -------------------------------------------------------------------------
def get_index(dir):
...
# -------------------------------------------------------------------------
# Switch current catalog (if needed)
# -------------------------------------------------------------------------
def set_current_catalog(catalog_name):
    spark.sql(f"USE CATALOG {catalog_name}")

# -------------------------------------------------------------------------
# Structured Streaming dataset helpers
# -------------------------------------------------------------------------
